...
class ToolRegistryYamlParsingTest {
    ...
    private static final String VALID_YAML = """
            tools:
              - name: ocr-file-manager
                image: 10.0.0.23:32000/ocr-file-manager:latest
                roles:
                  - knowledge-editor
                  - admin
              - name: quarkus-chat-ui
                image: 10.0.0.23:32000/quarkus-chat-ui:latest
                roles:
                  - user
                  - knowledge-editor
                  - admin
    ...
    void parse_validYaml_fieldsAreCorrect() throws Exception {
        ...
        assertEquals("10.0.0.23:32000/ocr-file-manager:latest", first.image());
    ...
    void getTool_existingName_returnsEntry() throws Exception {
        ...
        assertNotNull(entry);
        assertEquals("10.0.0.23:32000/quarkus-chat-ui:latest", entry.image());
    }
