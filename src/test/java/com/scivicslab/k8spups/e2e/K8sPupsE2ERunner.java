 ...
 * <p>Prerequisites:
 * <ul>
 *   <li>k8s-pups deployed at -De2e.base.url (default: https://203.0.113.10/local-llm)</li>
 *   <li>admin user exists (-De2e.username, -De2e.password)</li>
 ...
 *     -De2e.base.url=https://203.0.113.10:7443/local-llm \
 *     -De2e.username=admin \
