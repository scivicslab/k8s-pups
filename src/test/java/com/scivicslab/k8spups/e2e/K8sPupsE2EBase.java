...
abstract class K8sPupsE2EBase {
    ...
    protected static final String BASE_URL  = System.getProperty("e2e.base.url", "https://203.0.113.10:7443/local-llm");
    protected static final String USERNAME  = System.getProperty("e2e.username", "admin");
