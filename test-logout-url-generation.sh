...
BASE_PATH="/local-llm"
OIDC_ISSUER="https://203.0.113.10:7443/local-llm-auth/realms/local-llm"
OIDC_REDIRECT_BASE_URL="https://203.0.113.10:7443"
...
printf '%s\n' "$POST_LOGOUT_URI" | python3 -c "import sys, urllib.parse; print(urllib.parse.unquote(sys.stdin.read().strip()))" 2>/dev/null || echo "  https://203.0.113.10:7443/local-llm/"
