...
| `k8spups.workspace.nfs.server` | `10.0.0.20` | NFS server for home directories |
...
sudo docker build -t 10.0.0.23:32000/k8s-pups:$TAG .
...
kubectl set image deployment/k8s-pups-controller -n k8s-pups \
  k8s-pups=10.0.0.23:32000/k8s-pups:$TAG
...
- Container registry at `10.0.0.23:32000`
